 ...
 * <p>
 * The producer is <i>thread safe</i>. Sharing a single producer instance across
 * threads will
 ...
 *
 * // Create a
 * }{@link RoutingData#RoutingData(String, String, String)}
 * {@code getInstance
 * String topic = "topic1";
...
public class DatabusProducer<P> extends Producer<P> {
    ...
    /**
     * A DatabusProducer is instantiated by providing a set of key-value as
     * configuration.
     * Valid configuration strings
     * are documented <a href=
     * "http://kafka.apache.org/documentation.html#newproducerconfigs">here</a>.
     * Values can be
     * either strings or Objects of the appropriate type (for example a numeric
     * configuration would accept either the
     * string "42" or the integer 42).
     * <p>
     * Specific key-value from {@link ProducerDefaultConfiguration} will be added
     * unless they are provided by
     * SDK user
     * </p>
     *
     * @param configs           The DatabusProducer configs
     * @param messageSerializer an instance of {@link MessageSerializer} provided by
     *                          SDK's user, used to transform
     *                          the message to byte[]
     *                          when {@link Producer#send(ProducerRecord, Callback)}
     *                          sends the message
     * @throws DatabusClientRuntimeException if a DatabusProducer instance was not
     *                                       able to be created
     */
     ...
     * <p>
     * Specific key-value from {@link ProducerDefaultConfiguration} will be added
     * unless they are provided by SDK
     * user
     * </p>
     *
     * @param properties        The DatabusProducer configs
     * @param messageSerializer a instance of {@link MessageSerializer} provided by
     *                          SDK's user, used to transform
     *                          the message to byte[]
     *                          when {@link Producer#send(ProducerRecord, Callback)}
     *                          sends the message
     ...
     *
     * @param messageSerializer It is a serializer which will be assigned to the
     *                          DatabusProducer
     */
    ...
    /**
     * This method add settings kept into {@link ProducerDefaultConfiguration}
     * unless they are in configs parameter
     *
     * @param configs It is the configuration that a SDK's user sends when a new
     *                instance of DatabusProducer
     *                is created
     ...
     * unless they are in configs parameter
     *
     * @param properties It is the configuration that a SDK's user sends when a new
     *                   instance of DatabusProducer
     *                   is created
     * @return The configuration overrode
     */
    ...
    /**
     * This method add credential kept into a configuration for the {@link Producer}
     * instance
     *
     * @param configuration It is the configuration that a SDK's user sends when a
     *                      new instance of DatabusProducer
     *                      is created
     * @param credential    Identity to authentication/authorization
     */
    ...
    /**
     * String to prepend to error messages related to creation of DatabusProducer
     * instances
     */
